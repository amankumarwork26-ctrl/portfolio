export const certificationsData = [
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor">
        <path d="M8.855 14.18c.083.312.356.557.69.627a1.23 1.23 0 00.895-.068c.354-.189.56-.534.56-.915 0-.49-.317-.873-.797-1.042-.226-.08-.478-.14-.728-.176a6.25 6.25 0 01-.62-.128zm5.978-3.59c-.16-.16-.41-.264-.68-.264h-.02c-.26.008-.504.12-.68.32l-.016.02c-.12.152-.192.344-.192.548 0 .12.04.232.104.328l.008.012c.16.2.41.312.68.312h.02c.26-.008.504-.12.68-.32l.016-.02c.12-.152.192-.344.192-.548 0-.12-.04-.232-.104-.328l-.008-.012zM12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm5.39 7.04h-1.72c-.156 0-.304.04-.436.112a1.28 1.28 0 00-.36.304c-.088.12-.152.264-.184.416v4.88c0 .176.064.34.184.464.1.104.24.184.396.216.088.02.176.028.264.028h1.72c.4 0 .748-.148 1.004-.436.228-.252.34-.588.34-1.012V10.5c0-.424-.112-.76-.34-1.012-.256-.288-.604-.448-1.004-.448zM9.84 8.16H7.56c-.4 0-.748.148-1.004.436-.228.252-.34.588-.34 1.012v4.8c0 .424.112.76.34 1.012.256.288.604.436 1.004.436h2.28c.4 0 .748-.148 1.004-.436.228-.252.34-.588.34-1.012v-4.8c0-.424-.112-.76-.34-1.012-.256-.288-.604-.448-1.004-.448z" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor">
        <path d="M4 2l1.4 16L12 20l6.6-2L20 2H4zm12.4 5.2h-6.6l.2 2.2h6l-.6 6.6-4 1.2-4-1.2-.3-3.2h2l.1 1.8 2.2.6 2.2-.6.3-3H8.6L8.2 6h7.6l-.2 2.2-.2.0z" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <text x="6" y="17" fontSize="10" fontWeight="bold" fill="#000" fontFamily="sans-serif">JS</text>
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor">
        <path d="M4 2l1.6 18L12 22l6.4-2L20 2H4zm12.8 6H8.4l.2 2.4h7.8L15.6 14l-1.8.6-1.8-.6-.1-1.4h-2l.2 2.6 3.5 1 3.5-1 .4-4.4H16.8z" />
      </svg>
    ),
  },
];
