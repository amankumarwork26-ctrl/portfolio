        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <div className="contact-links">
              <a href="mailto:amankumar.work26@gmail.com" className="contact-link">
                <span className="cl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg></span>
                <div>
                  <span className="cl-label">Email</span>
                  <span className="cl-val">amankumar.work26@gmail.com</span>
                </div>
              </a>
              <a href="https://www.linkedin.com/in/aman-kumar-395a3535b" className="contact-link" target="_blank" rel="noopener noreferrer">
                ...
                <div>
                  ...
                  <span className="cl-val">aman-kumar-395a3535b</span>
                </div>
              </a>
              <a href="https://github.com/amankumarwork26-ctrl" className="contact-link" target="_blank" rel="noopener noreferrer">
                ...
                <div>
                  ...
                  <span className="cl-val">github.com/amankumar</span>
                </div>
              </a>
            </div>
          </div>
          <div className="contact-form-wrap">
            <form ref={formRef} id="contactForm" noValidate onSubmit={handleSubmit}>
              ...
              <button type="submit" className="btn btn-primary btn-full" id="submitBtn" disabled={sending}>
